...
public final class HmacVerificationRequestAdapter implements VerificationRequestAdapter
{
	                                                ...
	                                                final Clock clock)
	{
		...
		return new HmacVerificationRequestAdapter(configuration, clock);
	}
	...
	private HmacVerificationRequestAdapter(final TokenVerificationConfiguration configuration, final Clock clock)
	{
